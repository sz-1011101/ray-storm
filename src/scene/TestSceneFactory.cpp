...
ScenePtr TestSceneFactory::createCornellBox()
{
  ...
  materials::MaterialPtr matMetal = materials::MaterialFactory::createMetal(glm::vec3(0.5f, 0.25f, 0.25f), glm::vec3(0.5f, 0.25f, 0.1f), 35.0f);
  ...
  // light
  geometry::ObjectPtr sphereLight = geometry::ObjectPtr(new geometry::Sphere(glm::vec3(0, 10, 0), 1.0f, matWhite, glm::vec3(12.0f)));
